	...
	var CONSTANTS = {
	  ...
	  4: {
	    ...
	    html: {
	      ...
	      pageDropdown: ['<div id="dropdown-page" class="dropdown-menu dropdown-content">', '</div>'],
	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function initPagination() {
	      ...
	      if (!o.onlyInfoPagination) {
	        ...
	        var pageNumber = ["<span class=\"".concat(this.constants.classes.paginationDropdown, "\">\n        <button class=\"").concat(this.constants.buttonsClass, " dropdown-toggle dropdown-trigger btn\" type=\"button\" data-toggle=\"dropdown\" data-target=\"dropdown-page\">\n        <span class=\"page-size\">\n        ").concat($allSelected ? o.formatAllRows() : o.pageSize, "\n        </span>\n        ").concat(this.constants.html.dropdownCaret, "\n        </button>\n        ").concat(this.constants.html.pageDropdown[0])];
